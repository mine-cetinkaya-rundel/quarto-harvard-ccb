---
title: "Hello Quarto"
subtitle: "A World of Possibilities (for Reproducible Publishing)"
...
<https://github.com/mine-cetinkaya-rundel/quarto-harvard-ccb>
...
Quarto 1.3!
[https://quarto.org/docs/prerelease/1.3/](https://quarto.org/docs/prerelease/1.3)

```{=html}
<iframe src="https://quarto.org/docs/prerelease/1.3/index.html" width="100%" height="600" title="Quarto 1.3 Pre-release notes"></iframe>
```
## Follow up with...
